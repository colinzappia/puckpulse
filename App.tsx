...
const App: React.FC = () => {
  ...
  const handleConfirmEndGame = async () => { try { handleExportPDF(); } catch {} setShowEndGame(false); };
      ...
      <div className="fixed inset-0 z-[400] bg-black/90 backdrop-blur-sm flex items-center justify-center px-4">
        <div className="bg-[#0f1620] border border-white/10 rounded-2xl p-8 max-w-md w-full shadow-2xl">
          ...
          <div className="flex gap-3">
            ...
            <button onClick={handleConfirmEndGame} className="flex-1 py-3 bg-green-600 hover:bg-green-500 text-white font-black rounded-xl text-sm transition-colors">📥 Download Report</button>
          </div>
