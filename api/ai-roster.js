...
RULES: Only extract players from the text below. Extract jersey number, full name, and position for each player. Position: map to C, LW, RW, D, or G only. Line assignment: Forwards get 1,2,3,4. Defense get P1,P2,P3. Goalies get G1,G2. If jersey number missing use "00". No duplicates. ${NAME_RULE}
PASTED TEXT:
${pasteText}
