...
const Header: React.FC<HeaderProps> = ({
  ...
  onOpenSetup, onOpenManual, onOpenGameHistory, onOpenScouting, onSetPeriod, onSwapSides,
      ...
      <header className="bg-black/95 border-b border-white/10 backdrop-blur-3xl px-0 py-0 pt-safe flex items-center shadow-[0_15px_50px_rgba(0,0,0,0.9)] w-full">
        <div className="w-full flex flex-col">
          <div className="flex flex-col bg-white/5 border-b border-white/10 shadow-inner w-full relative group">
            ...
            {/* Top Names Bar */}
            <div className="flex justify-between items-center px-4 sm:px-12 md:px-24 py-1.5 sm:py-3 md:py-4 max-md:landscape:py-1 border-b border-white/5 bg-black/20">
            ...
            {/* Main Scoreboard Row */}
            <div className="flex items-center px-2 sm:px-8 md:px-16 py-2 sm:py-4 md:py-8 max-md:landscape:py-1.5 w-full max-w-7xl mx-auto">
            ...
            <div className="flex items-center justify-center gap-2 sm:gap-3 px-3 sm:px-6 py-2 sm:py-3 max-md:landscape:py-1 border-t border-white/5 bg-black/30">
              <button
                onClick={onOpenSetup}
