...
const AdvertisePage: React.FC<AdvertisePageProps> = ({ isOpen, onClose }) => {
  ...
  usePageMeta(
    'Partner With Us | Top Cheese Hockey',
    'Partnership and advertising opportunities with Top Cheese Hockey — reach coaches and hockey families directly.'
  );
  ...
  const tiers = [
    {
      ...
      badge: '',
      features: [
        'Logo + tagline in partner banner',
          ...
          <>
            ...
            <div className="bg-black/30 backdrop-blur-sm border border-white/10 rounded-2xl p-6 max-w-xl mx-auto">
              ...
              <div className="space-y-4">
                ...
                <div>
                  <label className="text-xs font-bold text-slate-400 uppercase tracking-wider block mb-1.5">Partnership Tier *</label>
